...
variable "cluster_type1" {
  default = ""
}

variable "cluster_type2" {
  default = ""
}

variable "cluster_type3" {
  default = ""
}
...
variable "kubernetes_version_Cluster1_pool1" {
  default = "v1.26.2"
}

variable "kubernetes_version_Cluster1_pool2" {
  default = "v1.27.2"
}
